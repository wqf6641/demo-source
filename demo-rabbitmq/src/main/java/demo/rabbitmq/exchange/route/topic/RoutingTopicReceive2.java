...
public class RoutingTopicReceive2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (String routingKey : routingKeys) {
				...
				System.out.println("RoutingTopicReceive2 exchange:" + EXCHANGE_NAME + ", queue:" + queueName
						+ ", BindRoutingKey:" + routingKey);
			}
			System.out.println("RoutingTopicReceive2 Waiting for messages");
			DefaultConsumer defaultConsumer = new DefaultConsumer(channel) {
				@Override
				public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties,
						byte[] body) throws IOException {
					System.out.println("RoutingTopicReceive2 Received :'" + envelope.getRoutingKey() + "|"
